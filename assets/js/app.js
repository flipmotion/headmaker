...
$(document).ready(function () {
	var labels = {
		'home1': ['Запись на "Маникюр"', 'Запись на маникюр'],
		'profile1': ['Запись на "Педикюр"', 'Запись на педикюр'],
		'messages1': ['Запись на "Моделирование ногтей"', 'Запись на моделирование ногтей'],
		'settings1': ['Запись в салон', 'Записаться'],
		'home': ['Запись на "Стрижки и укладки"', 'Запись на стрижку и укладку'],
		'profile': ['Запись на "Окрашивание и колорирование"', 'Запись на окрашивание и колорирование'],
		'messages': ['Запись на "Восстановление волос"', 'Запись на восстановление волос'],
		'settings': ['Запись в "Мужской зал"', 'Запись в мужской зал'],
		'default': ['Запись в салон', 'Записаться']
	};

	var replaceText = function replaceText(event) {
